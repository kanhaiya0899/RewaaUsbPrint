...
//    public static JSObject readDeviceData(UsbDevice device) {
//        JSObject ret = new JSObject();
//        ret.put("device_name", device.getDeviceName());
//        ret.put("device_class", nameForClass(device.getDeviceClass()));
//        ret.put("if_id", nameForClass(device.getDeviceClass()));
//        ret.put("if_class", nameForClass(device.getDeviceClass()));
//        JSArray ifData = new JSArray();
//        for (int i = 0; i < device.getInterfaceCount(); i++) {
//            JSObject ifJson = new JSObject();
//
//            UsbInterface intf = device.getInterface(i);
//            ifJson.put("if_id", intf.getId());
//            ifJson.put("if_class", nameForClass(intf.getInterfaceClass()));
//            ifJson.put("if_sub_class", intf.getInterfaceSubclass());
//            ifJson.put("if_protocol", intf.getInterfaceProtocol());
//            ifJson.put("if_endpoint", intf.getEndpointCount());
//
//            sb.append(String.format(Locale.US,
//                    "-- Interface %d Class: %s -> Subclass: 0x%02x -> Protocol: 0x%02x\n",
//                    intf.getId(),
