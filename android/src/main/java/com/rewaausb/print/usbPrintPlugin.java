...
public class usbPrintPlugin extends Plugin {
    ...
    private usbPrint implementation = new usbPrint();

    protected static usbPrintPlugin sPlugin;
    private Context mContext;
    private UsbManager mUSBManager;
    private PendingIntent mPermissionIndent;
    private UsbDevice mUsbDevice;
    private String TAG = "usbPrintPlugin";

    private UsbDeviceConnection mUsbDeviceConnection;
    private UsbInterface mUsbInterface;
    private UsbEndpoint mEndPoint;

    private static final String ACTION_USB_PERMISSION = "com.rewaausb.print.action.ACTION_USB_PERMISSION";
